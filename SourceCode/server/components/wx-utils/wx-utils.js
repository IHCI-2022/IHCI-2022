    ...
    openidList.map((item) => {
        if (typeof item.openid == 'string') {
            pub_pushTemplateMsg(
                item.openid,
                'p6pZBXX0SaqODRDZgY_3NqyIAK0mYN9HXYq6yMLyA04',
                'http://ihci.animita.cn/discuss/topic/' + discussObj.topicId,
                {
                    "first": {
    ...
    openidList.map((item) => {
        if (typeof item.openid == 'string') {
            pub_pushTemplateMsg(
                item.openid,
                'p6pZBXX0SaqODRDZgY_3NqyIAK0mYN9HXYq6yMLyA04',
                'http://ihci.animita.cn/discuss/topic/',
                {
                    "first": {
    ...
    openidList.map((item)=>{
        if(typeof item.openid == 'string'){
            pub_pushTemplateMsg(
                item.openid,
                'p6pZBXX0SaqODRDZgY_3NqyIAK0mYN9HXYq6yMLyA04',
                'http://ihci.animita.cn/todo/' + taskObj.id,
                {
                    "first": {
    ...
    openidList.map((item) => {
        if (typeof item.openid == 'string') {
            pub_pushTemplateMsg(
                item.openid,
                'p6pZBXX0SaqODRDZgY_3NqyIAK0mYN9HXYq6yMLyA04',
                'http://ihci.animita.cn/todo/' + taskObj._id,
                {
                    "first": {
    ...
    openidList.map((item) => {
        if (typeof item.openid == 'string') {
            pub_pushTemplateMsg(
                item.openid,
                'p6pZBXX0SaqODRDZgY_3NqyIAK0mYN9HXYq6yMLyA04',
                'http://ihci.animita.cn/todo/' + checkitemObj._id,
                {
                    "first": {
